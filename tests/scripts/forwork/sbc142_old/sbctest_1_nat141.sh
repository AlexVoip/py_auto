...
#### if FAIL2BAN will work only with REGISTER
##sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/uas_1xx.xml -mi $6 -m 1 -nd -i $6 -p $5 -recv_timeout 200s -timeout_error &
##sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $3 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error
##REZULT
##sleep 2

### need to comment if FAIL2BAN will work only with REGISTER
sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/uac_no_ans.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $3 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error
REZULT
