...
# Modem
sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/1a-uas_ssw.xml -mi $3 -m $6 -nd -i $3 -p $5 &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/3a-uac_ssw.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $3 -s $USER_A -ap $USER_A -l $6 -r $7 -m $6 -nd -i $3 -p $4 
