...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/regans.xml -mi $3 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error &
#sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uas_cancel.xml -mi $3 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/uac_cancel_wo180.xml -inf $TEMP_PATH/$USER_B-$USER_A.csv -mi $3 -s $USER_B -ap $USER_B -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $5 -recv_timeout 200s -timeout_error
REZULT
sleep 2
