...
$SIPP_PATH/sipp $IP_SBC_A:$PORT_SBC_AB -sf $SRC_PATH/uac_A.xml -inf $TEMP_PATH/ss_ct_by_refer/A.csv -mi $IP_A -nd -i $IP_A -p $port_A -timeout 30 -timeout_error -l 1 -r 1 -m 1
