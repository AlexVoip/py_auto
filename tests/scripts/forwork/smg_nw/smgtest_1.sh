...
COUNT=1 #needed 500 answer
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/reg_500.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $3 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error
REZULT
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/reg.xml -inf $TEMP_PATH/$USER_B-$USER_A.csv -mi $3 -s $USER_B -ap $USER_B -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $5 -recv_timeout 200s -timeout_error
REZULT
sleep 2
...
# UPDATE
sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/uas_update_prack_c.xml -mi $3 -m 1 -nd -i $3 -p $5 -recv_timeout 200s -timeout_error &
...
# Early UPDATE
sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/uas_update_bugearly2.xml -mi $3 -m 1 -nd -i $3 -p $5 -recv_timeout 200s -timeout_error &
...
#/*sudo $SIPP_PATH/sipp $2 -sf $SRC_PATH/uas.xml -mi $3 -m 1 -nd -i $3 -p $5 -recv_timeout 200s -timeout_error &
#sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_bug_cancel_after_answer2.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $3 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error
#REZULT
#*/sleep 2
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_errorcodec2.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $3 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $3 -p $4 -recv_timeout 200s -timeout_error
REZULT
sleep 2
