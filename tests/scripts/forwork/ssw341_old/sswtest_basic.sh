...
do
	COUNT=$(($COUNT+1))
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $5 -m 1 -nd -i $5 -p $PORT_B -recv_timeout 200s -timeout_error &
	sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uac_ssw.xml -inf $TEMP_PATH/$USER_A-$USER_B.csv -mi $5 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $5 -p $PORT_A -recv_timeout 200s -timeout_error
	REZULT
	sleep 5
	
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $5 -m 1 -nd -i $5 -p $PORT_C -recv_timeout 200s -timeout_error &
	sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uac_ssw.xml -inf $TEMP_PATH/$USER_A-$USER_C.csv -mi $5 -s $USER_A -ap $USER_A -rtp_echo -l 1 -r 1 -m 1 -nd -i $5 -p $PORT_A -recv_timeout 200s -timeout_error
	REZULT
	sleep 5

        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $5 -m 1 -nd -i $5 -p $PORT_A -recv_timeout 200s -timeout_error &
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uac_ssw.xml -inf $TEMP_PATH/$USER_B-$USER_A.csv -mi $5 -s $USER_B -ap $USER_B -rtp_echo -l 1 -r 1 -m 1 -nd -i $5 -p $PORT_B -recv_timeout 200s -timeout_error 
        REZULT
        sleep 5
                
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $5 -m 1 -nd -i $5 -p $PORT_C -recv_timeout 200s -timeout_error &
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uac_ssw.xml -inf $TEMP_PATH/$USER_B-$USER_C.csv -mi $5 -s $USER_B -ap $USER_B -rtp_echo -l 1 -r 1 -m 1 -nd -i $5 -p $PORT_B -recv_timeout 200s -timeout_error 
        REZULT
        sleep 5
        
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $5 -m 1 -nd -i $5 -p $PORT_A -recv_timeout 200s -timeout_error &
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uac_ssw.xml -inf $TEMP_PATH/$USER_C-$USER_A.csv -mi $5 -s $USER_C -ap $USER_C -rtp_echo -l 1 -r 1 -m 1 -nd -i $5 -p $PORT_C -recv_timeout 200s -timeout_error 
        REZULT
        sleep 5
                        
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $5 -m 1 -nd -i $5 -p $PORT_B -recv_timeout 200s -timeout_error &
        sudo $SIPP_PATH/sipp $4 -sf $SRC_PATH/$COUNT-uac_ssw.xml -inf $TEMP_PATH/$USER_C-$USER_B.csv -mi $5 -s $USER_C -ap $USER_C -rtp_echo -l 1 -r 1 -m 1 -nd -i $5 -p $PORT_C -recv_timeout 200s -timeout_error 
	REZULT
	sleep 5
done
