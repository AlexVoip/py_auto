...
sudo rm $TEMP_PATH/results_ss_cfb.txt
...
REZULT ()
{
  if test $? -ne 0
      then 
          ...
          echo Test $COUNT failed >> $TEMP_PATH/results_ss_cfb.txt
      else 
          SUCC_COUNT=$(($SUCC_COUNT+1))
          echo Test $COUNT passed >> $TEMP_PATH/results_ss_cfb.txt          
  fi
}
...
sudo rm $TEMP_PATH/${USER_MASS[4]}-${USER_MASS[0]}.csv
sudo rm $TEMP_PATH/${USER_MASS[5]}-${USER_MASS[1]}.csv
sudo rm $TEMP_PATH/${USER_MASS[6]}-${USER_MASS[2]}.csv
sudo rm $TEMP_PATH/${USER_MASS[10]}-${USER_MASS[9]}.csv 
...
echo "SEQUENTIAL;
${USER_MASS[4]};${USER_DOM_MASS[4]};${USER_MASS[0]};" > $TEMP_PATH/${USER_MASS[4]}-${USER_MASS[0]}.csv
echo "SEQUENTIAL;
${USER_MASS[5]};${USER_DOM_MASS[5]};${USER_MASS[1]};" > $TEMP_PATH/${USER_MASS[5]}-${USER_MASS[1]}.csv
echo "SEQUENTIAL;
${USER_MASS[6]};${USER_DOM_MASS[6]};${USER_MASS[2]};" > $TEMP_PATH/${USER_MASS[6]}-${USER_MASS[2]}.csv
echo "SEQUENTIAL;
${USER_MASS[10]};${USER_DOM_MASS[10]};${USER_MASS[9]};" > $TEMP_PATH/${USER_MASS[10]}-${USER_MASS[9]}.csv
...
# CFB once and with PRACK
COUNT=0
while [ $COUNT -lt 3 ] 
do
COUNT=$(($COUNT+1))

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[6]}-${USER_MASS[2]}.csv -mi $2 -s ${USER_MASS[6]} -ap ${USER_MASS[6]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
sleep 3
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[9]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[10]}-${USER_MASS[9]}.csv -mi $2 -s ${USER_MASS[10]} -ap ${USER_MASS[10]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[10]} -recv_timeout 200s -timeout_error &
sleep 3
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[5]}-${USER_MASS[1]}.csv -mi $2 -s ${USER_MASS[5]} -ap ${USER_MASS[5]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[5]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[6]}-${USER_MASS[2]}.csv -mi $2 -s ${USER_MASS[6]} -ap ${USER_MASS[6]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
sleep 3
...
#CFB three
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[0]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[4]}-${USER_MASS[0]}.csv -mi $2 -s ${USER_MASS[4]} -ap ${USER_MASS[4]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[4]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[1]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[5]}-${USER_MASS[1]}.csv -mi $2 -s ${USER_MASS[5]} -ap ${USER_MASS[5]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[5]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[6]}-${USER_MASS[2]}.csv -mi $2 -s ${USER_MASS[6]} -ap ${USER_MASS[6]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
...
COUNT=10
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/6-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[8]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[0]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[4]}-${USER_MASS[0]}.csv -mi $2 -s ${USER_MASS[4]} -ap ${USER_MASS[4]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[4]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[1]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/uac_10s.xml -inf $TEMP_PATH/${USER_MASS[5]}-${USER_MASS[1]}.csv -mi $2 -s ${USER_MASS[5]} -ap ${USER_MASS[5]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[5]} -recv_timeout 200s -timeout_error &
