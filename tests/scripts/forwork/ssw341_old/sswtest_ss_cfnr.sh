...
# Тест услуги "Переадресация по неответу" - CFNR. Версия ПО 3.3.
# 
...
REZULT ()
{
  if test $? -ne 0
      then 
          ...
          echo Test $COUNT failed >> $TEMP_PATH/results_ss_cfnr.txt
      else 
          SUCC_COUNT=$(($SUCC_COUNT+1))
          echo Test $COUNT passed >> $TEMP_PATH/results_ss_cfnr.txt          
  fi
}
...
echo "SEQUENTIAL;
${USER_MASS[$COUNT]};${USER_DOM_MASS[$COUNT]};*$CFNR_KOD*${USER_MASS[$(($COUNT+1))]}#;*#$CFNR_KOD#;#$CFNR_KOD#;*$CFNR_KOD#;" > $TEMP_PATH/${USER_MASS[$COUNT]}.csv
done
...
echo "SEQUENTIAL;
${USER_MASS[10]};${USER_DOM_MASS[10]};*$CFNR_KOD*${USER_MASS[0]}#;" > $TEMP_PATH/${USER_MASS[10]}-max.csv

echo "SEQUENTIAL;
${USER_MASS[0]};${USER_DOM_MASS[0]};*$CFNR_KOD*$USER_NR#;" > $TEMP_PATH/${USER_MASS[0]}-$USER_NR.csv
echo "SEQUENTIAL;
${USER_MASS[1]};${USER_DOM_MASS[1]};*$CFNR_KOD*$USER_UA#;" > $TEMP_PATH/${USER_MASS[1]}-$USER_UA.csv 
echo "SEQUENTIAL;
${USER_MASS[2]};${USER_DOM_MASS[2]};*$CFNR_KOD*$USER_NN#;" > $TEMP_PATH/${USER_MASS[2]}-$USER_NN.csv 
...
# CFNR once and with PRACK
COUNT=0
while [ $COUNT -lt 3 ] 
do
COUNT=$(($COUNT+1))

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[3]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/cfnr/$COUNT-uac_ssw.xml -inf $TEMP_PATH/${USER_MASS[7]}-${USER_MASS[2]}.csv -mi $2 -s ${USER_MASS[7]} -ap ${USER_MASS[7]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[7]} -recv_timeout 200s -timeout_error
REZULT
sleep 2

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[10]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[11]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/cfnr/$COUNT-uac_ssw.xml -inf $TEMP_PATH/${USER_MASS[7]}-${USER_MASS[10]}.csv -mi $2 -s ${USER_MASS[7]} -ap ${USER_MASS[7]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[7]} -recv_timeout 200s -timeout_error
REZULT
sleep 2

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[7]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/cfnr/$COUNT-uac_ssw.xml -inf $TEMP_PATH/${USER_MASS[3]}-${USER_MASS[6]}.csv -mi $2 -s ${USER_MASS[3]} -ap ${USER_MASS[3]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[3]} -recv_timeout 200s -timeout_error
REZULT
sleep 2

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[10]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[11]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/cfnr/$COUNT-uac_ssw.xml -inf $TEMP_PATH/${USER_MASS[3]}-${USER_MASS[10]}.csv -mi $2 -s ${USER_MASS[3]} -ap ${USER_MASS[3]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[3]} -recv_timeout 200s -timeout_error
REZULT
sleep 2

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[3]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/cfnr/$COUNT-uac_ssw.xml -inf $TEMP_PATH/${USER_MASS[11]}-${USER_MASS[2]}.csv -mi $2 -s ${USER_MASS[11]} -ap ${USER_MASS[11]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[11]} -recv_timeout 200s -timeout_error
REZULT
sleep 2

sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/$COUNT-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[7]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/cfnr/$COUNT-uac_ssw.xml -inf $TEMP_PATH/${USER_MASS[11]}-${USER_MASS[6]}.csv -mi $2 -s ${USER_MASS[11]} -ap ${USER_MASS[11]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[11]} -recv_timeout 200s -timeout_error
REZULT
sleep 2
...
#CFNR twice
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[1]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[9]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[10]} -recv_timeout 200s -timeout_error &
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[5]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
...
#CFNR three
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[0]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[1]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[2]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[3]} -recv_timeout 200s -timeout_error &
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[8]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[9]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[10]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[11]} -recv_timeout 200s -timeout_error &
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[4]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[5]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/9-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[6]} -recv_timeout 200s -timeout_error &
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/1-uas_ssw.xml -mi $2 -m 1 -nd -i $2 -p ${PORT_MASS[7]} -recv_timeout 200s -timeout_error &
...
sudo $SIPP_PATH/sipp $1 -sf $SRC_PATH/2-uac_180_ssw.xml -inf $TEMP_PATH/${USER_MASS[7]}-${USER_MASS[9]}.csv -mi $2 -s ${USER_MASS[7]} -ap ${USER_MASS[7]} -rtp_echo -l 1 -r 1 -m 1 -nd -i $2 -p ${PORT_MASS[7]} -recv_timeout 200s -timeout_error
REZULT 
sleep 2
...
# Конфигурируем необходимые таймеры
$SRC_PATH/sswconf_cfnr2.sh $3 $4 $5 $1  
